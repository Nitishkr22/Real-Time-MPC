...
struct ESRTrackReport_
{
  ...
  _header_type header;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _grouping_changed_type;
  _grouping_changed_type grouping_changed;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _oncoming_type;
  _oncoming_type oncoming;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _bridge_object_type;
  ...
  _status_type status;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _rolling_count_type;
  ...
  _range_rate_type range_rate;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _range_accel_type;
  ...
  _angle_type angle;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _lat_rate_type;
