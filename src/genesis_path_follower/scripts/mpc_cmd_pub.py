...
if controller_choice == 'kinematic_mpc':
	...
	MPC_PARAMS = {'N' : 10, 'DT' : 0.4, 'Q' : [4000., 4000., 40000., 200.], 'R' : [50., 500.]}  # Q = [x, y, psi, v], R= [u_{acc, -1}, u_{df, -1}]
	# MPC_PARAMS = {'N' : 10, 'DT' : 0.2, 'Q' : [20000., 20000., 40000., 20000.], 'R' : [20., 200.]}  # Q = [x, y, psi, v], R= [u_{acc, -1}, u_{df, -1}]
